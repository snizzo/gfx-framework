...
class EProtect {
	...
	public static function logout(){
		EHeader::del_cookie(EProtect::$localkey);
	...
	public static function checklogin(){
		$password = EHeader::get_cookie(EProtect::$localkey);
		if($password){
		...
		if(isset($_POST['password'])){
			...
			if($password == EConfig::$data['generic']['password']){
				EHeader::set_cookie(EProtect::$localkey, $password, 60); //60seconds*30 = max 30 minutes session
				return true;
			}
		}
